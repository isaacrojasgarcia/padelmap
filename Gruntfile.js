        ...
        concat: {
            ...
            vendor: {
                ...
                src: [
                    ...
                    '<%= padel.bower %>/momentjs/moment.js',
                    ...
                    '<%= padel.bower %>/angular-translate/angular-translate.js',
                    '<%= padel.bower %>/angular-translate-loader-partial/angular-translate-loader-partial.js',
                    '<%= padel.bower %>/angular-i18n/angular-locale_sv.js',
                    '<%= padel.bower %>/autobahnjs/autobahn/loadershim.js',
                    '<%= padel.bower %>/when/when.js',
                    '<%= padel.bower %>/autobahnjs/autobahn/autobahn.js',
